    ...
    <div className="register-body min-h-screen">
      <div className="register-card">
        ...
        <div className="logo-container">
          <img src="/assets/img/WhatsApp Image 2026-06-25 at 4.52.21 PM.jpeg" alt="2TOTAL STARS Logo" className="logo-img" />
          <img src="/assets/img/WhatsApp Image 2026-06-25 at 4.52.17 PM.jpeg" alt="2TOTAL CENTER Logo" className="logo-img" />
        </div>
